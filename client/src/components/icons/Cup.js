...
const SvgCup = (props) => (
  <svg width="248" height="244" viewBox="0 0 248 244" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M72.7783 88C35.7787 88 27.5234 55.4571 28.0208 39.1857V37H41.448V39.1857C41.448 69.4943 65.816 74.6429 78 73.4286V88H72.7783Z" fill="#FE5000" />
    <path d="M180.222 88C217.221 88 225.477 55.4571 224.979 39.1857V37H211.552V39.1857C211.552 69.4943 187.184 74.6429 175 73.4286V88H180.222Z" fill="#FE5000" />
    <rect x="115" y="117" width="23" height="33" fill="#E54800" />
    <path d="M68 38H185V81C185 103.091 167.091 121 145 121H108C85.9086 121 68 103.091 68 81V38Z" fill="#FE5000" />
    <path d="M97 153C97 151.343 98.3431 150 100 150H152C153.657 150 155 151.343 155 153V169H97V153Z" fill="#FE5000" />
    <path d="M78 172C78 170.343 79.3431 169 81 169H172C173.657 169 175 170.343 175 172V220H78V172Z" fill="url(#paint1_linear)" />
    ...
    <defs>
      <linearGradient id="paint0_linear" x1="126" y1="0" x2="126" y2="244" gradientUnits="userSpaceOnUse">
        ...
        <stop offset="0.833333" stop-color="#00151D" />
      </linearGradient>
